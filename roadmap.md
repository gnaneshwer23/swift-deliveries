...
- [ ] Phase 5: Coach dashboard rebuild (queue depth, submission detail, decision history)
- [ ] Phase 6: Pilot join follow-through + Professional Workspace depth (meetings, artefacts, consent-led observation)
- [ ] Emails (blocked: needs a sending domain)
- [ ] Payments and entitlements (blocked: needs a payment provider account)
- [ ] Explainable AI judgement run to replace the pilot scoring rule
